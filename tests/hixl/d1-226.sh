...
MASTER_IP_ADDRESS="x.x.x.225" # 主节点的IP地址
IP_ADDRESS="x.x.x.226"        # 当前节点的IP地址
SERVICE_PORT=8701
...
--compilation_config '{"cudagraph_mode":"FULL_DECODE_ONLY","cudagraph_capture_sizes":[1,2,4,8,16,32,64,128,256]}' \
--kv-transfer-config \
'{
